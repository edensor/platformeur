...
class Button extends StateGraphic
{
	...
	private function initStyle ():Void {
		upStyle={ font: "80px RoundedElegance", fill: "#0E2A38", align:"center"};
		overStyle={ font: "80px RoundedElegance", fill: "#AAAAAA", align:"center"};
		downStyle = { font: "80px RoundedElegance", fill: "#000000", align:"center" };
	}
	
	public function setText(pText:String,?pStyle:TextStyle):Void {
		txt.text = pText;
		if(pStyle!=null)txt.style = pStyle;
	}
