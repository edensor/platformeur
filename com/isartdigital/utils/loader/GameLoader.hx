...
class GameLoader extends Loader
{
	...
	*/
	...
	public static function getXml (pFile:String,pLang:String):Xml {
		return txtLoaded[Config.langPath+pLang+"/"+pFile];
	}
	...
	*/
	...
	/**
	* ajoute un fichier xml de localisation
	* @param	pUrl chaine de caractère spécifiant le nom du fichier
	*/
